...
- **THEN** the prompt stays and marks that it is waiting, and once a newer graph answer replaces the graph the prompt was confirmed against, the action is re-checked against it and either requested exactly once or refused with its reason
