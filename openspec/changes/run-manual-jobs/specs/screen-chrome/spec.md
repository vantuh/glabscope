...
- **THEN** the prompt stays and marks that it is waiting, and once that refresh lands the action is re-checked against its answer and either requested exactly once or refused with its reason
